...
public class BearbeitenAusgaben extends JFrame {
	...
	public BearbeitenAusgaben(int id) {
		...
		JLabel lblHinzuE = new JLabel("<html><u>Ausgaben bearbeiten</u></html>");
			...
			public void mouseClicked(MouseEvent e) {
				try {
					String selectedItem = (String) cboBearbeiten
							.getSelectedItem();
					// String sqlQuery =
					// "UPDATE BenutzerAufwendungen SET (Datum, Bezeichnung, Kategorie, Betrag Bemerkung) VALUES(?,?,?,?,?) WHERE ( Bezeichnung='"+selectedItem+"')  ";
					// "UPDATE BenutzerAufwendungen SET Datum= VALUE1,'Bezeichnung'=VALUE2,'Kategorie'=VALUE3,'Betrag'=VALUE4,'Bemerkung'=VALUE5 WHERE ( Bezeichnung='"+selectedItem+"')  ";
					...
					PreparedStatement pstm = connection2
							.prepareStatement(sqlQuery);
					// // Datum
					// pstm.setString(1, ((JTextField) txt_Datum.getDateEditor()
					// .getUiComponent()).getText());
					//
					// // Bezeichnung
					// pstm.setString(2, txtBezeichnung.getText());
					//
					// // Kategorie
					// String ausgewaelteKategorie = cboKategorie
					// .getSelectedItem().toString(); ///hieeeer
					// pstm.setString(3, ausgewaelteKategorie);
					//
					// // Art
					// // pstm.setString(4, "variabel");
					//
					// // Betrag
					// pstm.setString(4, txtBetrag.getText());
					//
					// // BenutzerID
					// // pstm.setLong(6, id);
					//
					// // Bemerkung
					// pstm.setString(5, txtBemerkung.getText());
